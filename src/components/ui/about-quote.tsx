        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Каждый день тысячи колористов тратят часы на то, что можно решить за 10 секунд. Подбор рецепта под натуральную базу, седину или предыдущее окрашивание — это всегда был риск. Пока не появился «Конструктор рецептов».
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы упаковали профессиональную химию и математику в один промт. Работает через бесплатный DeepSeek — без подписок, без сложных настроек. Просто вводите параметры и получаете рабочую формулу. Сделано мастерами для мастеров.
            </p>
          </div>
        </div>
      </div>
